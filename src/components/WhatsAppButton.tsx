...
export default function WhatsAppButton() {
  ...
  return (
    <a
      href={`https://wa.me/${data.contact.phone2?.replace(/[^0-9]/g, '')}?text=Hello%20FinTechra%20Solutions%2C%20I%20would%20like%20to%20know%20more%20about%20your%20services.`}
      target="_blank"
      rel="noreferrer"
    ...
    alt="WhatsApp"
    className="w-[30px] h-[30px] sm:w-[34px] sm:h-[34px] object-contain group-hover:scale-110 transform transition-transform duration-300"
  />
