...
const services = [
  {
    ...
    description: "Modern, responsive and high-performance websites designed specifically for your business.",
    icon: Monitor,
  },
  {
    title: "E-Commerce Solutions",
    description: "Complete e-commerce solutions that help businesses sell, manage orders and grow online.",
    icon: ShoppingCart,
  },
  {
    title: "AI-Powered Web Solutions",
    description: "Integrate AI into your website and business processes to automate tasks, improve customer experiences and work smarter.",
    icon: Cpu,
  },
  {
    title: "GST Registration & Filing",
    description: "Professional GST registration and filing support to help businesses manage their GST requirements.",
    icon: FileText,
  },
  {
    title: "Income Tax Return (ITR) Filing",
    description: "Reliable income tax return filing support for individuals and businesses.",
    icon: Calculator,
  },
  {
    title: "Accounting & Bookkeeping Services",
    description: "Organize your financial records, maintain your books and keep your business finances easier to manage.",
    icon: PieChart,
  },
];
      ...
      <div className="max-w-[1440px] mx-auto">
        <div className="px-5 sm:px-8 lg:px-12 flex flex-col items-center text-center mb-16 sm:mb-20">
          ...
          <p className="text-[16px] sm:text-[18px] text-textSecondary max-w-2xl leading-relaxed">
            From digital experiences to financial services, we provide practical solutions designed around your business.
          </p>
        </div>
